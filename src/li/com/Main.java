		...
		if(args.length == 0){
			...
			try{
				FileOutputStream fileOut = new FileOutputStream("data.ser");//creates a card serial file in output stream
			     ...
			     out.writeObject(d1);// we designate our array of cards to be routed
			...
			try{
	            ...
	            Department d1 = (Department) in.readObject();// allocate it to the object file already instanciated.
